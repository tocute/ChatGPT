//
//  ChatGPTOthersRepository.swift
//  ChatGPTExtension
//
//  Created by Bill Chang on 19/3/23.
//

import Foundation

final class ChatGPTOthersRepository: BaseChatGPTRepository {
    override func askChatGPTFor(_ apiKey: String?, source code: String, language: String) async throws -> Suggestion {
        ...
        do {
            let chatpGPTResponse = try await openAI.others(function: code)
